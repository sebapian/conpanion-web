...
import { ChevronLeft, ChevronRight, X, ZoomIn, ExternalLink, Download, ImageOff } from 'lucide-react';
        ...
        {imageUrls.map((image, index) => (
          <div 
            ...
            className={`relative cursor-pointer overflow-hidden rounded-md border bg-muted ${
              imageUrls.length === 1 ? 'aspect-video w-full max-w-md mx-auto' : 'aspect-square'
            }`}
          ...
          <div className="relative flex h-full min-h-[50vh] w-full items-center justify-center">
            ...
            <div className="absolute bottom-4 right-4 flex gap-2">
              <Button 
                ...
                asChild
              >
                <a href={imageUrls[currentImageIndex]?.url} target="_blank" rel="noopener noreferrer">
